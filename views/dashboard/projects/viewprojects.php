...
if (!empty($projectData)) {
    ...
    ?>
            ...
            <ul class="nav nav-pills maintab-wrap">
                <li class="active"><a data-toggle="tab" href="#menu0" id="menutab1" onclick="triggerTabActive('project1','#project','#menutab1')">Settings</a></li>
                <li><a data-toggle="tab" href="#menu1" id="menutab2" onclick="triggerTabActive('datafields1','#datafields','#menutab2')">Data</a></li>
                <li><a data-toggle="tab" href="#menu2" id="menutab3" onclick="triggerTabActive('colourscontent1','#colourscontent','#menutab3')" >Visuals</a></li>
            </ul>

              <div class="tab-content">
                <div id="menu0" class="tab-pane fade in active">
                  <ul class="nav nav-pills custom-tabs">
                    <li id="project1" class="submenu-li" onclick="mytabFun('project1','#project')">
                        <a href="#project" class="custom-tab-child" data-toggle="tab">Project</a>
                    </li>
                    
                        <?php
                        if ($templateData['is_social_share'] != 'no') {
                        if ($clientData['is_social_share'] == 'yes' || $clientData['is_tweet_mp'] == 'yes') { 
                        ?>
                    <li id="social1" class="submenu-li" onclick="mytabFun('social1','#social')">
                        <a href="#social" class="custom-tab-child" data-toggle="tab">Social</a>
                    </li>
                   ...
                   if (($clientData['is_email_friend'] == 'yes' || $clientData['is_mp'] == 'yes' )) {
                    ?>
                    <li id="email1" class="submenu-li" onclick="mytabFun('email1','#email')">
                        <a href="#email" class="custom-tab-child" data-toggle="tab">Email</a>
                    </li>
                     <?php } }
                    ?>
                ...
                <div id="menu1" class="tab-pane fade">
                  <ul class="nav nav-pills custom-tabs">
                    <li id="datafields1" class="submenu-li" onclick="mytabFun('datafields1','#datafields')">
                        <a href="#datafields" class="custom-tab-child" data-toggle="tab">Data Fields</a>
                    </li>
                    <li id="nodes1" class="submenu-li" onclick="mytabFun('nodes1','#nodes')">
                        <a href="#nodes" class="custom-tab-child" data-toggle="tab">Nodes</a>
                    </li>
                    <li id="importexport1" class="submenu-li" onclick="mytabFun('importexport1','#importexport')">
                        <a href="#importexport" class="custom-tab-child" data-toggle="tab">Import/Export</a>
                    </li>
                 </ul>
                </div>
                <div id="menu2" class="tab-pane fade">
                  <ul class="nav nav-pills custom-tabs">
                    <li id="colourscontent1" class="submenu-li" onclick="mytabFun('colourscontent1','#colourscontent')">
                        <a href="#colourscontent" class="custom-tab-child" data-toggle="tab">Colours & Content</a>
                    </li>
                    <li id="charts1" class="submenu-li" onclick="mytabFun('charts1','#chartswizards')">
                        <a href="#chartswizards" class="custom-tab-child" data-toggle="tab">Charts</a>
                    </li>
                    <li id="groups1" class="submenu-li" onclick="mytabFun('groups1','#groups')">
                        <a href="#groups" class="custom-tab-child" data-toggle="tab">Groups</a>
                    </li>
                </ul>
                </div>
              </div>
            ...
            <div class="row">
            <!---TAB-PROJECT---->
            <div class="tab-pane tab-submenu" id="project">
            <div class="col-md-6">
            ...
            <div class="form-group">
                <input type="hidden" name="project_id" value="<?php echo $projectId; ?>">
                <input type="text" class="form-control" onkeyup="checkinique(this.value,'<?php echo $projectId; ?>')" name="unique_url" id="unique_url" placeholder="Unique URL" <?php $url = str_replace('-', ' ', $data['name']); ?> value="<?php if ($data['unique_url'] == null) {
                              echo strtolower(str_replace(' ', '-', preg_replace('/[^A-Za-z0-9 ]/', '', $url)));
                          } else {
                                        ...
                                        <div class="project-dtails">
                                            <form id="projectSettingsForm" action="<?php echo BASE_URL . 'projects/update_settings' ?>" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
            <input type="hidden" name="hide_node" id="hide_node" class="dn" value="yes" <?php if ($data['hide_node'] == 'yes') {
                echo 'checked';
            } ?>  />
             <?php if ($clientData['is_charts'] == 'yes') { ?>
                            <div class="toggleWrapper">
                                ...
                                <input type="checkbox" name="is_charts" id="charts" class="dn"
                                    value="yes" <?php if ($data['is_charts'] == 'yes') {
                                        echo 'checked';
                                    } ?> />
            ...
            <?php } ?>
                ...
                <div class="toggleWrapper">
                    ...
                    <input type="checkbox" name="is_pdf_download" id="pdf_download" class="dn"
                        value="yes" <?php if ($data['is_pdf_download'] == 'no') {
                            echo '';
                        } else {
                            echo 'checked';
                        } ?> />
                ...
                <div class="toggleWrapper">
                    ...
                    <input type="checkbox" name="is_image_export" id="image_export" class="dn"
                        value="yes" <?php if ($data['is_image_export'] == 'no') {
                            echo '';
                        } else {
                            echo 'checked';
                        } ?> />
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="pro-heading">
                           <h4>Subscription confirmation email text</h4>
                    </div>
                    <div class="form-group">
            ...
            value="publish" <?php if ($data['visibility'] == 1) {
                echo 'checked';
            } ?> />
            ...
            <input type="checkbox" name="password_protected" onclick="updateprojectStatus(this,'project')" id="password_protected" value="password_protected" <?php if ($data['password_protected'] == 1) {
                echo 'checked';
            } ?> />
            ...
            <!---END-TAB-PROJECT---->
            <!---START-TAB-SOCIAL---->
            <div class="tab-pane tab-submenu" id="social">
            <div class="row">
                                                                        <div class="col-md-6">
                                                                            <form method="post" action="<?php echo BASE_URL . 'projects/update_social_settings' ?>">
                                                                            <div class="project-dtails">
                                                                               <div class="form-group">
                                                                                    <?php
                                                                                    if ($templateData['is_social_share'] != 'no') {
                                                    ...
                                                    style="<?php if ($data['is_social_share'] != 'yes') {
                                                        echo 'display:none';
                                                    } ?>">
                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="form-group">
                                                                                                            <div class="custom-checkbox">
                                                                                                                <input type="checkbox" name="is_twitter"
                                                                                                                    ...
                                                                                                                    class="" value="yes"
                                                                                                                    <?php if ($data['is_twitter'] != 'no') {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                                                                                                <label for="is_twitter">Twitter</label>
                                                                                                            </div>
                                                                                                            <input type="text" class="form-control share-text"
                                                                                                                style="<?php if ($data['is_twitter'] == 'no') {
                                                                                                                    echo 'display:none';
                                                                                                                } ?>"
                                                                                                                name="is_twitter_text" id="is_twitter_share"
                                                                                                                placeholder="Message"
                                                                                                                value="<?php if ($data['is_twitter'] == 'no') {
                                                                                                                    echo $clientData['is_twitter'];
                                                                                                                } else {
                                                                                                                    echo $data['is_twitter'];
                                                                                                                } ?>">
                                                                                                        </div>
                                                                                                    </div>
                                                    <?php }
                                                                                                        ...
                                                                                                        <div class="form-group">
                                                                                                            <div class="custom-checkbox">
                                                                                                                <input type="checkbox" name="is_linkedin"
                                                                                                                    ...
                                                                                                                    class="" value="yes"
                                                                                                                    <?php if ($data['is_linkedin'] != 'no') {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                                                                                                <label for="is_linkedin">Linkedin</label>
                                                                                                            </div>
                                                                                                            <input type="text" class="form-control share-text "
                                                                                                                style="<?php if ($data['is_linkedin'] == 'no') {
                                                                                                                    echo 'display:none';
                                                                                                                } ?>"
                                                                                                                name="is_linkedin_text" id="is_linkedin_share"
                                                                                                                placeholder="Message"
                                                                                                                value="<?php if ($data['is_linkedin'] == 'no') {
                                                                                                                    echo $clientData['is_linkedin'];
                                                                                                                } else {
                                                                                                                    echo $data['is_linkedin'];
                                                                                                                } ?>">
                                                                                                        </div>
                                                                                                    </div>
                                                    <?php } ?>
                                                                                    ...
                                                                                    if ($templateData['is_tweet_mp'] != 'no') {
                                                                                        if ($clientData['is_tweet_mp'] == 'yes') { ?>
                                                                                                                                                ...
                                                                                                                                                <div class="form-group">
                                                                                                                                                    ...
                                                                                                                                                    <input type="checkbox" name="is_tweet_mp" onclick="enabletweetMP(this)" id="tweet_mp" class="dn" value="yes" <?php if ($data['is_tweet_mp'] != null) {
                                                                                                                                                        if ($data['is_tweet_mp'] == 'yes') {
                                                                                                                                                            echo 'checked';
                                                                                                                                                        }
                                                                                                                                                    } ?> />
                                                                                                                                                <label for="tweet_mp" class="toggle"><span class="toggle__handler"></span></label>
                                                                                                                                                            ...
                                                                                                                                                            <div class="form-group" id="tweetMptext"
                                                                                                                                                                style="<?php if ($data['is_tweet_mp'] !== 'yes') {
                                                                                                                                                                    echo 'display:none';
                                                                                                                                                                } ?>">
                                                                                            ...
                                                                                            <input type="hidden" name="id_project" value="<?php echo $projectId; ?>">
                                                                <input type="submit" name="update_social_setting" class="btn cus-btn" id="projectSettingsFormbtnnew" value="Update">
                                            </div>
                                            </form>
                                                                                        </div>
                                                                                    </div>
            ...
            <!---START-TAB-EMAIL---->
             <?php
                   ...
                   if (($clientData['is_email_friend'] == 'yes' || $clientData['is_mp'] == 'yes' )) {
                    ...
                    ?>
            <div class="tab-pane tab-submenu" id="email">
            <div class="row">
                                                                                        <div class="col-md-6">
                                                                                             <form method="post" action="<?php echo BASE_URL . 'projects/update_mail_settings' ?>">
                                                                                            <div class="project-dtails">
                                                                                            <div class="form-group">
                                                <?php
                                                if ($templateData['is_email_friend'] != 'no') {
                                                                                                                                                    ...
                                                                                                                                                    <div class="form-group">
                                                                                                                                                                                                            <label for="is_email_friend">Email a friend</label>
                                                                                                                                                                                                                <input type="checkbox" onclick="enableemailfriend(this)"
                                                                                                                                                                                                                    name="is_email_friend" id="is_email_friend" class="dn"
                                                                                                                                                                                                                    value="yes"
                                                                                                                                                                                                                    <?php if ($data['is_email_friend'] == 'yes') {
                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                    } ?>>
                                                                                                                                                                                                                <label for="is_email_friend" class="toggle"><span class="toggle__handler"></span></label>
                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                </div>
                                                                                                                                                                                                            <div class="row" id="emailfriend"
                                                                                                                                                                                                                style="<?php if ($data['is_email_friend'] !== 'yes') {
                                                                                                                                                                                                                    echo 'display:none';
                                                                                                                                                                                                                } ?>">
                                                                                                                                                                                                                <div class="col-md-12">
                                                                                                                                                                                                                    <div class="form-group">
                                                ...
                                                if ($clientData['is_email_share'] == 'yes') { ?>
                                                                                                    ...
                                                                                                    if ($clientData['is_mp'] == 'yes') { ?>
                                                                                                                                                  <div class="toggleWrapper">
                                                                                                                                                    <div class="form-group">
                                                                                                                                                        ...
                                                                                                                                                        <input type="checkbox" name="is_email_mp" onclick="emailMp(this)" id="email_mp" class="dn" value="yes" <?php if ($data['is_mp'] == 'yes') {
                                                                                                                                                            echo 'checked';
                                                                                                                                                        } ?> />
                                                                                                                                                ...
                                                                                                                                                <div class="col-md-12">
                                                                                                                                                    ...
                                                                                                                                                    <label for="">Model Header</label>
                                                                                                                                                        <textarea class="form-control emailMPmodelEditer" name="emailmp_MH" id="emailmp_MH" placeholder="[Salutation] Write the text you want people to show in Email MP Model Header"><?php if ($data['emailmp_MH'] == null || $data['emailmp_MH'] == '') {
                                                                                                                                                            if ($clientData['emailmp_MH'] == '' || $clientData['emailmp_MH'] == null) {
                                                                                                                                                                echo $templateData['emailmp_MH'];
                                                                                                                                                            } else {
                                                                                                                                                                echo $clientData['emailmp_MH'];
                                                                                                                                                            }
                                                                                                                                                        } else {
                                                                                                                                                            echo $data['emailmp_MH'];
                                                                                                                                                        } ?></textarea>
                                                                                                                                                 </div>
                                                                                                                                                </div>
                                                                                                                                                            <div class="col-md-12">
                                                                                            ...
                                                                                            <input type="hidden" name="id_project" value="<?php echo $projectId; ?>">
                                                                <input type="submit" name="update_mail_setting" class="btn cus-btn" value="Update">
                                                                
                                            </div>
                                            </form>
                                                                                        </div>
                                                                                         <div class="col-md-6 policy-wrap" style="<?php if ($data['is_mp'] != 'yes') { echo 'display:none'; } ?>">
                                <div class="form-group">
                                        <div class="project-dtails">
                                            <div class="pro-details-inner">
                                                <div class="pro-heading">
            ...
            <?php } } ?>
            <!---END-TAB-EMAIL---->
            <!---START-TAB-DATAFIELDS---->
            <div class="tab-pane tab-submenu" id="datafields">
            <div class="col-md-6">
            <div class="form-group">
            <div class="project-dtails">
            <div class="pro-details-inner">
...
class="mjs-nestedSortable-branch mjs-nestedSortable-expanded <?php if ($dataf['isGroup'] == 1) {
                                    echo 'group-true';
                                } ?>"
...
<!--Restrict Children restrict_children-->
                                                <div style="<?php if ($dataf['isGroup'] == 1) {
                                                    echo 'display:block';
                                                } else {
                                                    echo 'display:none';
                                                } ?>" class="restrict_children-btn group-btn toggleWrapper rcb<?php echo $dataf['id_project_field']; ?>">
                                                <div class="form-group">
                                                ...
                                                ?>
                                                <?php
                                                if ($dataf['field_type'] == 'Text' || $dataf['field_type'] == 'Hyperlink') {
                                                } else {
                                                    ?>
    ...
    <span>
        <?php
                        // echo $field_data->groupingMethod; ?></span>
                                                ...
                                                <div style="<?php if ($dataf['restrict_children'] == 1) {
                                                    echo '';
                                                } else {
                                                    echo 'display:none';
                                                } ?>" class="form-group">
                                                ...
                                                if (!empty($datafieldsChild)) {
                                                    ...
                                                    ?>
                                                            <ol>
                                                            <?php foreach ($datafieldsChild as $dchild) {
                                                                $countn++;
                                                                ?>
                                                                        <li style="display: list-item;"
            ...
            <span><?php
                                    // echo $field_data->groupingMethod; ?></span>
                                                                                ...
                                                                                <?php } ?>
                                                                        <div class="btn-rounded">
                                                                          <a class="btn btn-danger tool" data-tip="Delete" onclick="return letsconfirm('Are you sure you want to Delete?','<?php echo $CurPageURL . '?id=' . $dchild['id_project_field'] . '&&proid=' . $projectId; ?>')" href="javascript:void(0)"><i class="fa red fa-trash"></i></a>
                ...
                <div class="grp-btns">
                    <button class="btn cus-btn" name="toArray" id="toArray"> <span>Update</span> </button>
                    <button class="btn register-link" onclick="addFields('<?php echo $projectId; ?>','<?php echo $mid; ?>')">Add DataField</button>
                </div>
            ...
            <!---END-TAB-DATAFIELDS---->
            <!---START-TAB-NODES---->
            <div class="tab-pane tab-submenu" id="nodes">
            <div class="col-md-6">
            <div class="row">
            <div class="col-md-12">
            ...
            <!---END-TAB-NODES---->
            <!---START-TAB-IMPORTEXPORT---->
            <div class="tab-pane tab-submenu" id="importexport">
            <div class="col-md-6">
            <div class="form-group">
            ...
            <!---END-TAB-IMPORTEXPORT---->
            <!---START-TAB-COLOURSCONTENT---->
            <div class="tab-pane tab-submenu" id="colourscontent">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="project-dtails">
                                            ...
                                            <span> </span>
                                                        ...
                                                        <div class="pro-details-inner">
                                                            ...
                                                            <div class="inner-details">
                                                                ...
                                                                <span
                                                                    class="colour-value ng-binding"><?php if ($data['primary_color'] == null) {
                                                                        echo $clientData['primary_color'];
                                                                    } else {
                                                                        echo $data['primary_color'];
                                                                    } ?></span>
                                                                <span class="colour-preview"
                                                                    style="background-color:<?php if ($data['primary_color'] == null) {
                                                                        echo $clientData['primary_color'];
                                                                    } else {
                                                                        echo $data['primary_color'];
                                                                    } ?>"></span>
                                                            ...
                                                            <div class="inner-details">
                                                                ...
                                                                <span
                                                                    class="colour-value ng-binding"><?php if ($data['secondary_color'] == null) {
                                                                        echo $clientData['secondary_color'];
                                                                    } else {
                                                                        echo $data['secondary_color'];
                                                                    } ?></span>
                                                                <span class="colour-preview"
                                                                    style="background-color:<?php if ($data['secondary_color'] == null) {
                                                                        echo $clientData['secondary_color'];
                                                                    } else {
                                                                        echo $data['secondary_color'];
                                                                    } ?>"></span>
                                                              ...
                                                              <div class="inner-details">
                                                                ...
                                                                <span
                                                                    class="colour-value ng-binding"><?php if ($data['text_color'] == null) {
                                                                        echo $clientData['text_color'];
                                                                    } else {
                                                                        echo $data['text_color'];
                                                                    } ?></span>
                                                                <span class="colour-preview"
                                                                    style="background-color:<?php if ($data['text_color'] == null) {
                                                                        echo $clientData['text_color'];
                                                                    } else {
                                                                        echo $data['text_color'];
                                                                    } ?>"></span>
                                                             ...
                                                             <div class="inner-details">
                                                                ...
                                                                <span
                                                                    class="colour-value ng-binding"><?php if ($data['text_color2'] == null) {
                                                                        echo $clientData['text_color2'];
                                                                    } else {
                                                                        echo $data['text_color2'];
                                                                    } ?></span>
                                                                <span class="colour-preview"
                                                                    style="background-color:<?php if ($data['text_color2'] == null) {
                                                                        echo $clientData['text_color2'];
                                                                    } else {
                                                                        echo $data['text_color2'];
                                                                    } ?>"></span>
                                                             ...
                                                             <div class="inner-details">
                                                                ...
                                                                <span
                                                                    class="colour-value ng-binding"><?php if ($data['text_color3'] == null) {
                                                                        echo $clientData['text_color3'];
                                                                    } else {
                                                                        echo $data['text_color3'];
                                                                    } ?></span>
                                                                <span class="colour-preview"
                                                                    style="background-color:<?php if ($data['text_color3'] == null) {
                                                                        echo $clientData['text_color3'];
                                                                    } else {
                                                                        echo $data['text_color3'];
                                                                    } ?>"></span>
            ...
            <div class="form-group">
            <div class="custom-checkbox">
                                                                                        <input type="checkbox" name="iframe_logo" id="iframe_logo" class="" value="1">
                                                                                        <label for="iframe_logo">Logo</label>
                                                                                    </div>
            </div>
            <div class="form-group">
            <div class="custom-checkbox">
                                                                                        <input type="checkbox" name="iframe_location" id="iframe_location" class="" value="1">
                                                                                        <label for="iframe_location">Location Dropdown</label>
                                                                                    </div>
            </div>
            <div class="form-group">
            <div class="custom-checkbox">
                                                                                        <input type="checkbox" name="iframe_share_icon" id="iframe_share_icon" class="" value="1">
                                                                                        <label for="iframe_share_icon">Share Icon</label>
                                                                                    </div>
            </div>
            <div class="form-group">
            <div class="custom-checkbox">
                                                                                        <input type="checkbox" name="iframe_introtext" id="iframe_introtext" class="" value="1">
                                                                                        <label for="iframe_introtext">Intro Text</label>
                                                                                    </div>
            </div>
            <div class="form-group">
            <div class="custom-checkbox">
                                                                                        <input type="checkbox" name="iframe_footer" id="iframe_footer" class="" value="1">
                                                                                        <label for="iframe_footer">Footer</label>
                                                                                    </div>
            </div>
            <div class="form-group">
            ...
            <!---END-TAB-COLOURSCONTENT---->
            <!---START-TAB-CHARTSWIZARDS---->
            <div class="tab-pane tab-submenu" id="chartswizards">
            <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="project-dtails">
                                            <div class="pro-heading">
            ...
            <!---END-TAB-CHARTSWIZARDS---->
            <!---START-TAB-GROUPS---->
            <div class="tab-pane tab-submenu" id="groups">
            <div class="col-md-6">
            <div class="form-group">
            <div class="project-dtails">
            <div class="pro-details-inner">
                ...
                foreach ($groupData as $gdata) {
                    ...
                    if ($grpProject != null) {
                        ...
                        $grpProject = array();
                                    ...
                                    <option value="<?php echo $gdata['id']; ?>"<?php if (in_array($projectId, $grpProject)) {
                                           echo 'selected';
            ...
            <div class="col-md-12">
                ...
                if (!empty($allprojectsClients)) {
                    foreach ($allprojectsClients as $apclientspro) { ?>
                                        <option value="<?php echo $apclientspro['id_project']; ?>"
                                        <?php if ($apclientspro['id_project'] == $projectId) {
                                            echo 'selected';
                                        } ?>>
...
<!--//filed value model-->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-checkbox">
                                                            <input type="checkbox" onclick="enablelogofile(this)" name="file" id="logofile"
                                                                class="" value="yes" <?php if ($data['logo'] != null) {
                                                                    echo 'checked';
                                                                } ?>>
                                                        ...
                                                        ?>">
                                                            ...
                                                            <input type="text" class="form-control value-filled" name="logourl" id="logo"
                                                                ...
                                                                value="<?php if ($data['logourl'] == null) {
                                                                    echo $clientData['logo'];
                                                                } else {
                                                                    echo $data['logourl'];
                                                                } ?>">
                                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="colorBox">
                                                    <input type="text" class="colorValueInput form-control"
                                                        ...
                                                        value="<?php if ($data['primary_color'] == null) {
                                                            echo $clientData['primary_color'];
                                                        } else {
                                                            echo $data['primary_color'];
                                                        } ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="colorBox">
                                                    <input type="text" class="colorValueInput form-control"
                                                        onchange="colorValueChange(this)"
                                                        value="<?php if ($data['secondary_color'] == null) {
                                                            echo $clientData['secondary_color'];
                                                        } else {
                                                            echo $data['secondary_color'];
                                                        } ?>" />
                                                ...
                                                <div class="colorBox">
                                                    <input type="text" class="colorValueInput form-control"
                                                        onchange="colorValueChange(this)"
                                                        value="<?php if ($data['text_color'] == null) {
                                                            echo $clientData['text_color'];
                                                        } else {
                                                            echo $data['text_color'];
                                                        } ?>" />
                                                ...
                                                <div class="colorBox">
                                                    <input type="text" class="colorValueInput form-control"
                                                        onchange="colorValueChange(this)"
                                                        value="<?php if ($data['text_color2'] == null) {
                                                            echo $clientData['text_color2'];
                                                        } else {
                                                            echo $data['text_color2'];
                                                        } ?>" />
                                                ...
                                                <div class="colorBox">
                                                    <input type="text" class="colorValueInput form-control"
                                                        onchange="colorValueChange(this)"
                                                        value="<?php if ($data['text_color3'] == null) {
                                                            echo $clientData['text_color3'];
                                                        } else {
                                                            echo $data['text_color3'];
                                                        } ?>" />
            ...
            <div class="modal cus-modal-f" id="ImportModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    ...
                    <label for="chooseFile">Please add column labels BEFORE matching row values.</label>
                                            <div class="custom-file">
