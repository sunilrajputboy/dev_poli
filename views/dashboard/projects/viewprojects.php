        ...
        <div class="table-area addpackages edit-project">
            ...
            <div class="alert alert-success" id="sucessMessage" style="display: none;">
            	...
            	<?php if (
                 ...
                 !empty($_SESSION["success_msg"])
             ) { ?>
                        <div class="alert alert-success" id="sucessMessages">
                                <p id="suc_msg"><?php echo $_SESSION[
                                    "success_msg"
                                ]; ?></p>
                        </div>
					<?php
     ...
     unset($_SESSION["error_msg"]);
                                ...
                                <span> </span>
                                            ...
                                            <div class="pro-details-inner">
                                                <div class="inner-details">
                                                    ...
                                                    <p class="data-value"><?php echo $data[
                                                        "name"
                                                    ]; ?>
                                                    </p>
                                                </div>
                                ...
                                <span> </span>
                                            ...
                                            <div class="pro-details-inner">
                                                ...
                                                <div class="inner-details">
                                                    ...
                                                    <span
                                                        class="colour-value ng-binding"><?php if (
                                                            $data[
                                                                "primary_color"
                                                            ] == null
                                                        ) {
		...
		<div class="form-group">
                            ...
                            <div class="project-dtails">
                                <div class="pro-details-inner">
                                    <div class="datafields">
                                        ...
                                        <?php
                                        $uid = $_SESSION["uid"];
                                        $groupData = $mthis->model->getProjectGroupClientId(
                                            $cid
                                        );
                                        ?>
              ...
              foreach ($groupData as $gdata) {
                  ...
                  ?>
	<option value="<?php echo $gdata["id"]; ?>"<?php if (
    in_array($projectId, $grpProject)
) {
    echo "selected";
                        ...
                        <div class="form-group">
                            <div class="project-dtails">
                                <div class="pro-details-inner">
                                   ...
                                   <?php
                                   $allprojectsClients = $mthis->model->getProjectByClientId(
                                       $cid
                                   );
                        ...
                        <div class="form-group">
                            <div class="project-dtails import-export">
                                ...
                                <ul>
									...
									<li>
                                        <a href="javascript:void(0)" onclick="viewImportedNodes('<?php echo $projectId; ?>','<?php echo BASE_URL .
    "export/view"; ?>')">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                            <span>View Data</span>
                                        </a>
                                        <img id="loaderedit" style="display:none" src="<?php echo BASE_URL .
                                            "public/web/"; ?>images/ajax-loader.gif">
                                    </li>
									<li>
<a href="<?php echo BASE_URL."export/exportnodelink/".$pId; ?>" target="_blank" class="">
 <i class="fa fa-upload" aria-hidden="true"></i> <span>Export Node Link </span>
</a>
                                    </li>
                                </ul>
                            </div>
										...
										<div class="equal-height">
                                            <div class="col-md-6 equal-height-node">
                                                       ...
                                                       <div class="droptarget" id="allFacets" ondrop="drop(event)" ondragover="allowDrop(event)">
                                                           ...
                                                           if (
                                                            ...
                                                            <!-- <div class="group-fields-item-div"> -->
                                                                ...
                                                                <div class="fields-item group-fields-item">
                                                                    <input type="text" disabled class="disabled" value="<?php echo $dparent[
                                                                        "field_name"
                                                                    ]; ?>" readonly>
                                                                </div>
                                                            ...
                                                            $datafieldsChild = $mthis->model->getProjectFieldsByParentId(
                                                                $parentId
                                                            );
                                                            if (
                                                                !empty(
                                                           ...
                                                           <p ondragstart="dragStart(event)" ondrag="dragging(event)" draggable="true" id="<?php echo $dchild[
                                                               "id_project_field"
                                                           ]; ?>" class="dfield_name"><?php echo $dchild[
    "field_name"
]; ?></p>
                                                           <div class="colorBoxm">
                                                                <input type="text" class="colorValueInput form-control" onchange="colorValueChange(this)" value="<?php echo isset(
                                                                    $prokeycolor[
                                                                        $key
                                                                    ]
                                                                )
                                                                    ...
                                                                    : "#000000"; ?>">
                                                                <input type="color" class="colorInput" name="field_color[]" onchange="colorChange(this)" id="colors" value="<?php echo isset(
                                                                    $prokeycolor[
                                                                        $key
                                                                    ]
                                                                )
                                                    ...
                                                    <?php
                                                           ...
                                                           <p ondragstart="dragStart(event)" ondrag="dragging(event)" draggable="true" id="<?php echo $dparent[
                                                               "id_project_field"
                                                           ]; ?>" class="dfield_name"><?php echo $dparent[
    "field_name"
]; ?></p>
                                                           <div class="colorBoxm">
                                                                <input type="text" class="colorValueInput form-control" onchange="colorValueChange(this)" value="<?php echo isset(
 ...
 <input type="hidden" class="form-control" name="proid" id="proid" value="<?php echo $projectId; ?>">
                  ...
                  <?php if (!empty($chartWizard)) {
                      ...
                      <li>
                          ...
                          <span class="badge"><?php echo $chart[
                              "graph_for"
                          ]; ?></span>
                             </div>
                         <div>
                              <a class="btn btn-danger tool" onclick="return letsconfirm('Are you sure you want to Delete?<?php echo $chart[
                                  "name"
                              ]; ?>','<?php echo BASE_URL; ?>projects/deletechart/<?php echo $chart[
    "id"
]; ?>')" href="javascript:void(0)" data-tip="Delete"><i class="fa red fa-trash"></i></a>
                     <a class="btn btn-info tool" href="javascript:void(0)" data-tip="Edit" onclick="getChartWizard('<?php echo $chart[
                         "id"
                     ]; ?>','<?php echo $projectId; ?>')"><i class="fa green fa-edit"></i></a>
                         </div>
                    <span class="indexc" style="display:none"><?php echo $chart[
                        "sequence_no"
                    ]; ?></span>
                    <input type="hidden" value="<?php echo $chart[
                        "id"
                    ]; ?>" name="shortposition[]" class="shortposition">
                      </li>
				  <?php
                      }
                  } ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="project-dtails">
                                            ...
                                            <section id="demo">
                                                <ol
                                                    ...
                                                    <li style="display: list-item;"
                                                        class="mjs-nestedSortable-branch mjs-nestedSortable-expanded <?php if (
                                                            $dataf["isGroup"] ==
                                                            1
                                                        ) {
                                                            echo "group-true";
                                                        } ?>"
                                                        id="menuItem_<?php echo $dataf[
                                                            "id_project_field"
                                                        ]; ?>">
                                                        <span class="index" style="display:none"><?php echo $count; ?></span>
                                                        <input type="hidden" style="display:none" name="shortposition[]"  value="<?php echo $dataf[
                                                            "id_project_field"
                                                        ]; ?>" />
                                                        <div class="menuDiv">
                                                            ...
                                                            <span>
                                                                <span
                                                                    ...
                                                                    class="itemTitle"><?php echo $dataf[
                                                                        "field_name"
                                                                    ]; ?></span>
                				...
                				<div class="group-btn toggleWrapper">
                        				<div class="form-group">
                        					...
                        					<input type="checkbox" name="is_datagroup"
                        						onclick="isdatagroup(this,'<?php echo $dataf[
                                  "id_project_field"
                              ]; ?>')"
                        						id="is_datagroup<?php echo $dataf[
                                  "id_project_field"
                              ]; ?>"
                                  ...
                                  echo "checked";
                        						...
                        						class="dn" value="1">
                        					<label
                        						for="is_datagroup<?php echo $dataf[
                                  "id_project_field"
                              ]; ?>"
                        						class="toggle"><span
                        							class="toggle__handler"></span></label>
                              ...
                              echo "display:none";
                          } ?>" class="restrict_children-btn group-btn toggleWrapper rcb<?php echo $dataf[
    "id_project_field"
]; ?>">
                        				<div class="form-group">
                        					<label for="">Restrict Children’s Options</label>
                        					<input type="checkbox" name="restrict_children"
                        						onclick="isdatagroupBYRestrictChildren('<?php echo $dataf[
                                  "id_project_field"
                              ]; ?>')"
                        						id="restrict_children<?php echo $dataf[
                                  "id_project_field"
                              ]; ?>"
                                  ...
                                  echo "checked";
                        						...
                        						class="dn" value="1">
                        					<label
                        						for="restrict_children<?php echo $dataf[
                                  "id_project_field"
                              ]; ?>"
                        						class="toggle"><span
                        							class="toggle__handler"></span></label>
                                                            ...
                                                            <div id="menuEdit<?php echo $dataf[
                                                                "id_project_field"
                                                            ]; ?>"
                                                                class="menuEdit hiddenDiv">
                                                                <div class=""
                                                                    id="id<?php echo $dataf[
                                                                        "id_project_field"
                                                                    ]; ?>">
                                                   ...
                                                   <?php $field_data = json_decode(
                                                       $dataf["field_data"]
                                                   ); ?>
                                                    <?php
                                                    if (
                                                        !$field_data->comparable !=
                                                        "true"
                                                    ) { ?>
                                                                    <div class="datafieldsall">
                                                    ...
                                                    ?>
                                                                ...
                                                                ?>
                                                                    <!-- <div class="datafieldsall">
                                                                        ...
                                                                        <span>
                                                                            <?php
                                                                // echo $field_data->groupingMethod;
                                                                ?></span>
                                                                    </div> -->
                                                                    <?php
                                                                // }
                                                                ?>
                                                                    <?php if (
                                                                        !$field_data->includeAverageInNodeGraphs !=
                                                                        "true"
                                                                    ) { ?>
                                                                    <div class="datafieldsall">
                                                                        <label> Show average:
                                                                    ...
                                                                    <?php } ?>
                                                                    <?php if (
                                                                        !$field_data->showChartDatasetSummary !=
                                                                        "true"
                                                                    ) { ?>
                                                                    <div class="datafieldsall">
                                                                    ...
                                                                    <div class="datafieldsall">
                                                                        <label> Exclude minimum from data set summary
                                                                            chart: </label>
                                                                        <span><?php if (
                                                                            !$field_data->excludeMinFromDataSetSummaryGraph !=
                                                                            true
                                                                        ) {
                                                                            echo "Yes";
                                                                        } else {
                                                                    ...
                                                                    <div class="datafieldsall">
                                                                        <label> Exclude maximum from data set summary
                                                                            chart: </label>
                                                                        <span><?php if (
                                                                            !$field_data->excludeMaxFromDataSetSummaryGraph !=
                                                                            true
                                                                        ) {
                                                                            echo "Yes";
                                                                        } else {
                                                                    ...
                                                                    <div class="datafieldsall">
                                                                        <label> Exclude average from data set summary
                                                                            chart: </label>
                                                                        <span><?php if (
                                                                            !$field_data->excludeAverageFromDataSetSummaryGraph !=
                                                                            true
                                                                        ) {
                                                                            echo "Yes";
                                                                        } else {
                                                                    ...
                                                                    <?php } ?>
                                                                    <?php if (
                                                                        !$field_data->showTotalInDataSetSummary !=
                                                                        "true"
                                                                    ) { ?>
                                                                    <div class="datafieldsall">
            ...
            <a class="btn btn-danger tool" data-tip="Delete" onclick="return letsconfirm('Are you sure you want to Delete?','<?php echo BASE_URL .
                "projects/deletedatafield/?id=" .
                $dataf["id_project_field"] .
                "&&proid=" .
                $projectId; ?>')" href="javascript:void(0)"> <i class="fa red fa-trash"></i></a>
			
            <a 
            <?php
                                                                //if($dataf['restrict_children'] == 1){ echo ''; }else{ echo 'disabled';}
                                                                ?> 
            class="btn btn-info tool" data-tip="Edit" onclick="editProjectsForm(<?php echo $dataf[
                "id_project_field"
            ]; ?>,<?php echo $projectId; ?>)" href="javascript:void(0)"><i class="fa green fa-edit"></i></a>
                                                                    </div>
        ...
        echo "display:none";
				 ...
				 <a class="btn cus-btn" data-tip="Edit" id="editkey<?php echo $dataf[
         "id_project_field"
     ]; ?>"
					onclick="editProjectsKey(<?php echo $dataf[
         "id_project_field"
     ]; ?>,<?php echo $projectId; ?>)"
                    ...
                    <?php foreach ($datafieldsChild as $dchild) {
                        $countn++; ?>
                                                            <li style="display: list-item;"
                                                                ...
                                                                id="menuItem_<?php echo $dchild[
                                                                    "id_project_field"
                                                                ]; ?>">
                                                                <span class="index" style="display:none"><?php echo $countn; ?></span>
                                                                <input type="hidden" style="display:none" name="shortposition[]"  value="<?php echo $dchild[
                                                                    "id_project_field"
                                                                ]; ?>" />
                                                                <div class="menuDiv">
                                                                    <span title="Click to show/hide children"
                                                                    ...
                                                                    <span>
                                                                        <span
                                                                            ...
                                                                            class="itemTitle"><?php echo $dchild[
                                                                                "field_name"
                                                                            ]; ?></span>
                                                                        <span title="Click to delete item."
                                                                            data-id="<?php echo $dchild[
                                                                    ...
                                                                    <div id="menuEdit<?php echo $dchild[
                                                                        "id_project_field"
                                                                    ]; ?>"
                                                                        class="menuEdit hiddenDiv">
                                                                        <div class=""
                                                                            id="id<?php echo $dchild[
                                                                                "id_project_field"
                                                                            ]; ?>">
                                                                            <div class="datafieldsall">
                                                                                <label>Description: </label>
                                                                                <span><?php echo $dchild[
                                                                                    "description"
                                                                                ]; ?></span>
                                                                            </div>
                                                                            <div class="datafieldsall">
...
<?php if ($field_data->graphType != "") { ?>
                        ...
                        ?>
                                                                            ...
                                                                            <div class="btn-rounded">
                                                                                <a class="btn btn-danger tool"
                                                                                    data-tip="Delete"
                                                                                    onclick="return letsconfirm('Are you sure you want to Delete?','<?php echo $CurPageURL .
                                                                                        "?id=" .
                                                                                        $dchild[
                                                                                            "id_project_field"
                                                                                        ] .
                                                                                    ...
                                                                                    href="javascript:void(0)"><i
                                                                                        class="fa red fa-trash"></i></a>
                                                                                         <a class="btn btn-info tool" data-tip="Edit" onclick="editProjectsForm(<?php echo $dchild[
                                                                                             "id_project_field"
                                                                                         ]; ?>,<?php echo $projectId; ?>)" href="javascript:void(0)"><i class="fa green fa-edit"></i></a>
             ...
             <div class="form-group">
				 <a class="btn cus-btn" data-tip="Edit" id="editkey<?php echo $dchild[
         "id_project_field"
     ]; ?>"
					onclick="editProjectsKey(<?php echo $dchild[
         "id_project_field"
     ]; ?>,<?php echo $projectId; ?>)"
					href="javascript:void(0)">Edit Map key</a>
			 </div>
           ...
           echo "checked";
						...
						<label for="dndo" class="toggle"><span
								class="toggle__handler"></span></label>
                                    ...
                                    <div class="row">
	<div class="col-md-12" id="passProtected" style="<?php if (
     $data["visibility"] != 1
 ) {
     echo "display:none";
 } ?>">
	...
	<input type="checkbox" name="password_protected" onclick="updateprojectStatus(this,'project')" id="password_protected" value="password_protected" <?php if (
     $data["password_protected"] == 1
 ) {
     echo "checked";
 } ?> />
				...
				<label for="password_protected">Password protected</label>
                                ...
                                <div class="addPassword" style="<?php if (
                                    $data["password_protected"] != 1
                                ) {
                                    echo "display:none";
                                } ?>">
                    ...
                    <?php $templateData = !empty($allTemplate)
                        ? $allTemplate[0]
                        : []; ?>
                    <!--project setting-->
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="project-dtails">
                                <form id="projectSettingsForm" action="<?php echo BASE_URL .
                                    "projects/update_settings"; ?>" method="post"
                                    style="max-width:100%">
                                    <div class="pro-heading">
...
<?php if ($templateData["is_mp"] != "no") {
  ...
  <div class="toggleWrapper">
	<div class="form-group">
		...
		<input type="checkbox" name="is_email_mp" onclick="emailMp(this)" id="email_mp" class="dn" value="yes" <?php if (
      $data["is_mp"] == "yes"
  ) {
      echo "checked";
  } ?> />
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<textarea class="form-control " name="message" id="msg"
						placeholder="[Salutation] Write the text you want people to send their MPS"><?php if (
          $data["message"] == null ||
          $data["message"] == ""
      ) {
...
<input type="hidden" name="hide_node" id="hide_node" class="dn" value="yes" <?php if (
    $data["hide_node"] == "yes"
) {
    echo "checked";
} ?>  />
                                                ...
                                                <div id="socialshareSetting"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" name="is_insta" value="yes">
                                                           <input type="hidden" name="is_insta_text" value="<?php echo $data[
                                                               "is_insta"
                                                           ]; ?>">
                                                        <?php
                                                        if (
...
<div class="form-group">
	...
	<input type="checkbox" name="is_tweet_mp" onclick="enabletweetMP(this)" id="tweet_mp" class="dn" value="yes" <?php if (
     $data["is_tweet_mp"] != null
 ) {
...
<div>
	<div class="form-group" id="tweetMptext" style="<?php if ($data["is_tweet_mp"] !== "yes") { echo "display:none"; } ?>">
			<label for="tweetMptext">MP tweet text</label>
			<textarea name="tweet_mp_text" placeholder="Write MP tweet text"
			class="form-control tweet-mp-text"><?php if (
			$data["tweet_mp_text"] == null ||
			$data["tweet_mp_text"] == ""
			) {
...
<div class="row">
	<div class="form-group">
		...
		<div class="cta_textWrapper">
			  <?php $cta_text = $data["cta_text"]; ?>
			<textarea name="cta_text" id="cta_text" placeholder="Write CTA text" class="form-control"><?php echo $cta_text; ?></textarea>
		</div>
	</div>
</div>
									    	...
									    	<div class="col-md-12">
												...
												<div class="form-group">
													...
													<div class="toggleWrapper m-l-0">
													      <?php $text = isset($data["subscribe_mail_text"])
                       ? $data["subscribe_mail_text"]
                       : (isset($clientData["subscribe_mail_text"])
                           ? $clientData["subscribe_mail_text"]
                           : $templateData["subscribe_mail_text"]); ?>
												...
												<div class="form-group">
													...
													<div class="m-l-0">
													     <?php $addresss = isset($data["subscribe_mail_address"])
                      ? $data["subscribe_mail_address"]
                      : (isset($clientData["subscribe_mail_address"])
                          ? $clientData["subscribe_mail_address"]
                          : $templateData["subscribe_mail_address"]); ?>
													...
													<div class="m-l-0">
													     <?php $ctitle = isset($data["copyright_title"])
                      ? $data["copyright_title"]
                      : (isset($clientData["copyright_title"])
                          ? $clientData["copyright_title"]
                          : $templateData["copyright_title"]); ?>
													...
													<div class="m-l-0">
													      <?php $clink = isset($data["copyright_link"])
                       ? $data["copyright_link"]
                       : (isset($clientData["copyright_link"])
                           ? $clientData["copyright_link"]
                           : $templateData["copyright_link"]); ?>
                        ...
                        <div class="form-group">
                            <div class="project-dtails">
                                <div class="pro-details-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form id="ppform" action="<?php echo BASE_URL .
                                                "projects/updateprivacypolicy"; ?>" method="post"
                                                style="max-width:100%">
                                                <div class="form-group">
                                                      <?php
                                                      $templateDatas = !empty(
                            ...
                            <div class="col-md-12">
                                <div class="project-dtails nodes-table">
                                    ...
                                    <div class="pro-details-inner" id="connstitutedata">
                                        <img id="loadereditnodes" style="display:none" src="<?php echo BASE_URL .
                                            "public/web/"; ?>images/ajax-loader.gif">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-body">
                <form action="javascript:void(0)" id="editProject" class="edit-project" method="post">
                    <div class="row">
                        ...
                        <textarea style="display:none;" class="" name="name"><?php echo $data[
                            "name"
                        ]; ?></textarea>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control required textarea-input" name="title" id="title"><?php echo $data[
                                    "title"
                                ]; ?></textarea>
                    ...
                    <div class="pro-logo row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <img src="<?php echo "/uploads/" .
                                    $data["logo"]; ?>" class="data-value" />
                                <?php } elseif ($data["logourl"] != null) { ?>
                                <img src="<?php echo $data[
                                    "logourl"
                                ]; ?>" class="data-value" />
                                <?php } elseif (
                        ...
                        <div class="col-md-12">
                            <div class="description_data">
                                ...
                                <textarea class="form-control textEditor" name="description"
                                    placeholder="Description"><?php echo $data[
                                        "description"
                                    ]; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div id="color_type1">
                                <div class="range-sliders">
                                    <input class="inputmixer range-slider__range" type="range" id="numsteps" value="<?php if (
                                        $colorArray != null
                                    ) {
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <div id="color_type2">
                                ...
                                <div class="m-5" id="addBtnBox" style="<?php if (
                                    $count < 10
                                ) { ?>display:block<?php } else {echo "display:none";} ?>">
                        ...
                        <div class="col-md-12">
                            <div class="footer_content_data">
                                ...
                                <textarea class="form-control nodeIntroEditor" 
                                    name="node_intro"
                                    placeholder="Node Intro Text"><?php echo $data[
                                        "node_intro"
                                    ]; ?></textarea>
                        ...
                        <div class="col-md-12">
                            <div class="footer_content_data">
                                ...
                                <textarea class="form-control nodeEditor" 
                                    ...
                                    placeholder="Node description"><?php echo $data[
                                        "node_description"
                                    ]; ?></textarea>
                        ...
                        <div class="col-md-12">
                            <div class="footer_content_data">
                                ...
                                <textarea class="form-control printEditor" 
                                    ...
                                    placeholder="Print description"><?php echo $data[
                                        "print_description"
                                    ]; ?></textarea>
                        ...
                        <div class="col-md-12">
                            <div class="footer_content_data">
                                ...
                                <textarea class="form-control footerEditor" onkeyup="previewFooter()"
                                    name="footer_content"
                                    placeholder="Footer content"><?php echo $data[
                                        "footer_content"
                                    ]; ?></textarea>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="">Name</label>
                                    ...
                                    placeholder="Name"><?php echo $data[
                                        "name"
                                    ]; ?></textarea>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo BASE_URL .
                    "import/importdata/"; ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
