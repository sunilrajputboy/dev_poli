    ...
    <h3>Clients</h3>
      <a href="<?php echo BASE_URL; ?>clients/add" title="" class="btn cus-btn">
            ...
            <div class="widget">
                ...
                <button class="btn btn-light-red" onclick="return dowithselected('delete','clients')"  value="delete" > <i class="fa red fa-trash"></i>  <span>Delete</span></button>
                <button class="btn btn-light-gray" onclick="return dowithselected('suspend','clients')"  value="hide" > <i class="fa fa-eye-slash"></i> <span>Suspend</span> </button>
                <button class="btn btn-light-green" onclick="return dowithselected('active','clients')"  value="show" > <i class="fa fa-eye"></i> <span>Activate</span> </button>
            </div>
                  </div>
                                ...
                                <tr <?php if($row['is_suspended'] == 1){ ?>class="tr_suspended"<?php } ?>>
                                   ...
                                   <div class="custom-checkbox">
                                   	...
                                   	<div class="btn-group btn-rounded ml-2">
                                              ...
                                              <li><a class="btn btn-info tool"  href="<?php echo BASE_URL.'clients/edit/'.$row['id']; ?>" data-tip="Edit"><i class="fa green fa-edit"></i></a></li>
                                                <li>
                                   ...
                                   <a  class="btn btn-success tool" href="<?php echo BASE_URL.'clients/suspendclients/?id='.$row['id']; ?>" data-tip="Suspend"><i class="fa fa-eye"  ></i></a>
                                    ...
                                    <li> <a class="btn btn-danger tool" onclick="return letsconfirm('Are you sure you want to Delete?<p><?php echo str_replace("'","-", str_replace('"','-', $row['name']));?></p>','<?php echo  BASE_URL.'clients/delete/?id='. $row['id']; ?>')" href="javascript:void(0)" data-tip="Delete"><i class="fa red fa-trash" ></i></a></li>
                                              </ul>
                                            </div> 
                                    </td>
...
$time = $dt->format('H:i:s');
                                    ...
                                    echo $date; ?></span></td>
                                     <td><span class=""><?php 
									 $register_by_id=!empty($row['register_by']) ? $row['register_by'] : 1 ;
                                     $userDataAll1 = $mthis->model->getUserById($register_by_id);
									 $userDataAll = !empty($userDataAll1) ? $userDataAll1[0] : array();
                                     ?>
                                     <a class="badge badge-primary" href="<?php echo BASE_URL; ?>users/profile/?id=<?php echo $userDataAll['id']; ?>"><?php echo !empty($userDataAll['name']) ? $userDataAll['name'] : ''; ?></a>
                                     <?php ?></span></td>
