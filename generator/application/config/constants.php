...
defined('ADMIN_EMAIL_ID') OR define('ADMIN_EMAIL_ID', "info@polimapper.co.uk");
define('FROM_EMAIL', 'support@polimapper.co.uk');
...
define('LAST_DAYS', '14');
define('TOOL_RELEASE_DATE', '2018-08-30 00:00:01');

/* Database Tables Constants */
define('ADMIN', 'tb_admin');
define('USERS', 'tb_users');
define('STORES', 'tb_stores');
